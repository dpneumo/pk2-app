...
# rbenv
sudo -u ${USERNAME} git clone https://github.com/rbenv/rbenv.git /home/${USERNAME}/.rbenv
sudo -u ${USERNAME} cd /home/${USERNAME}/.rbenv && src/configure && make -C src
sudo -u ${USERNAME} echo 'export PATH="$HOME/.rbenv/bin:$PATH"' >> /home/${USERNAME}/.bash_profile
sudo -u ${USERNAME} source /home/${USERNAME}/.bash_profile
